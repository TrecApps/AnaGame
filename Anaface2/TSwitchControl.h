 ...
 * Purpose: Holds a collection of Controls, dispaying one at a time
 * 
...
public:
	 ...
	 */
	TSwitchControl(TrecPointer<DrawingBoard> drawingBoard, TrecPointer<TArray<styleTable>> styles);
...
protected:
     ...
     */
    TrecSubPointer<TPage, TabBar> tabBar;
