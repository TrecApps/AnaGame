...
public:
     ...
     */
    HRESULT ProcessFrame(TrecComPointer<IMFMediaType> pCurrentType, IMFSample* pSample, UINT32* punInterlaceMode, BOOL* pbDeviceChanged, IMFSample** ppOutputSample = NULL);
    /**
